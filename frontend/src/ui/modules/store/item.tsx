  ...
  return (
    <>
      <div
        ref={ref}
        className={`${css} ${
          isDragging || isOver ? "ring-1 ring-gray-400" : ""
        } flex justify-between items-center bg-gray-50 rounded p-3 divide-x-2 transition-all duration-200`}
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          <div
            className={`flex text-sm font-medium min-w-[30px] ${handleColorInventory(
              shoe.inventory,

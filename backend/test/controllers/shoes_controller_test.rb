...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference("Shoe.count") do
      post shoes_url, params: { shoe: { inventory: @shoe.inventory, name: @shoe.name, store_id: @shoe.store_id } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { inventory: @shoe.inventory, name: @shoe.name, store_id: @shoe.store_id } }
